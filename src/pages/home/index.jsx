  ...
  return (
    ...
    >
      <header>
        ...
        <div
          id="main-div"
          className="flex flex-col gap-[5rem] pt-[4rem] px-16 max-w-[100rem]  mx-auto   w-full justify-between  min-h-[30rem] text-[80px] max-2xl:pt-[4rem] max-2xl:gap-[4rem] max-xl:text-[50px] max-sm:text-[27px]  max-sm:px-8 max-sm:gap-[3rem]   max-sm:min-h-[20rem]"
        >
          <div className="flex  text-[var(--black)]">
            ...
            <div className="w-full pl-8 flex items-center  max-sm:pl-2">
              {" "}
              <hr className="border-[var(--black)] w-full  translate-y-4 max-xl:translate-y-2 max-sm:translate-y-1" />
            </div>
          </div>
          <div className="flex justify-start text-[100px] text-[var(--black)] max-xl:text-[65px] max-sm:text-[30px]">
            <h1>&</h1>
          </div>
          <div className="flex items-center">
            <hr className="border-[var(--black)] w-full mr-4 translate-y-4 max-xl:translate-y-2 max-sm:translate-y-0  max-sm:mr-2" />
